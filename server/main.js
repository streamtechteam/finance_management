// // mock-api.js - Minimal mock API with JSON persistence & phone-based auth
...
//       const initialData = {
//         users: [
//           { id: 1, phone: '+1234567890', password: 'admin123', role: 'admin' },
//           { id: 2, phone: '+0987654321', password: 'user123', role: 'user' },
//           { id: 3, phone: '+1122334455', password: 'user456', role: 'user' }
//         ],
//         projects: [
...
// // Login endpoint — now uses "phone" instead of "username"
...
// // Get current user — returns phone
...
// // Create user (admin only) — requires phone
...
//   users.push(newUser);
//   persist();
//   res.status(201).json({ id: newUser.id, phone: newUser.phone, role: newUser.role });
// });

// // Update user (admin only) — can update phone
...
//   persist();
//   res.json({ id: users[userIndex].id, phone: users[userIndex].phone, role: users[userIndex].role });
// });
...
//   res.json({ status: 'OK', message: 'Mock API with phone auth & JSON persistence is running' });
// });
...
//   console.log('- User:  phone: +0987654321, password: user123');
// });

// module.exports = app;


// mock-api.js - Minimal mock API with JSON persistence, phone-based auth, and status in every response
...
//   res.status(200).json({
//     status: 200,
//     message: 'Mock API with phone auth, JSON persistence, and status codes is running'
//   });
// });
...
// mock-api.js - Minimal mock API with short UUIDs, phone auth, JSON persistence, and status codes
...
function loadDB() {
  try {
    if (!fs.existsSync(DB_PATH)) {
      const initialData = {
        users: [
          { id: nanoid(8), phone: '+1234567890', password: 'admin123', role: 'admin' },
          { id: nanoid(8), phone: '+0987654321', password: 'user123', role: 'user' },
          { id: nanoid(8), phone: '+1122334455', password: 'user456', role: 'user' }
        ],
        projects: [
